...
?>     
    ...
    <?php echo $statvar['StatName']; ?>: <?php echo $statvar['StatValue']; ?>    <?phpinclude "view-nbateams-editform.php";?>    
      <form method="post" action="">
        <input type="hidden" name="statvalueid" value="<?php echo $statvar['StatValueID']; ?>">
